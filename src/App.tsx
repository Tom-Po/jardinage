...
import Seed, { SeedType } from './component/Seed';
...
function App() {
  const [seeds, setSeeds] = useState<SeedType[]>([{
    ...
    type: 'Plantes potagères',
    growingMonths: [0, 3, 4, 5, 6]
  },
  {
    name: "Rhubarbe",
    type: 'Plantes potagères',
    growingMonths: [0, 1, 2, 3, 4, 5, 6]
  },
  {
    name: "Patisson",
    type: 'Plantes potagères',
